...
{	
	...
	///// CONSTANTS ///////////
	double* const _array_synapses_6_lastupdate = _dynamic_array_synapses_6_lastupdate.empty()? 0 : &_dynamic_array_synapses_6_lastupdate[0];
const int _numlastupdate = _dynamic_array_synapses_6_lastupdate.size();
...
const int _numt = 1;
double* const _array_synapses_6_w = _dynamic_array_synapses_6_w.empty()? 0 : &_dynamic_array_synapses_6_w[0];
const int _numw = _dynamic_array_synapses_6_w.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_6__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_6_lastupdate = _array_synapses_6_lastupdate;
 ...
 double* __restrict  _ptr_array_synapses_6_w = _array_synapses_6_w;
 int32_t* __restrict  _ptr_array_synapses_6__synaptic_post = _array_synapses_6__synaptic_post;
   ...
   double v_post = _ptr_array_neurongroup_6_v[_postsynaptic_idx];
   const double w = _ptr_array_synapses_6_w[_idx];
   const double t = _ptr_array_defaultclock_t[0];
   double lastupdate;
   v_post += w;
   lastupdate = t;
   _ptr_array_synapses_6_lastupdate[_idx] = lastupdate;
   _ptr_array_neurongroup_6_v[_postsynaptic_idx] = v_post;
    ...
    synapses_6_pre_codeobject_profiling_info += _run_time;
}
