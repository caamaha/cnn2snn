...
const int _numN_outgoing = _dynamic_array_synapses_4_N_outgoing.size();
...
const int _num_presynaptic_idx = _dynamic_array_synapses_4__synaptic_pre.size();
...
const int _numN_incoming = _dynamic_array_synapses_4_N_incoming.size();
const int _numtargets = 400000;
...
const int _num_synaptic_post = _dynamic_array_synapses_4__synaptic_post.size();
const int _numsources = 400000;
const int _num_postsynaptic_idx = _dynamic_array_synapses_4__synaptic_post.size();
const int _numN = 1;
const int _num_synaptic_pre = _dynamic_array_synapses_4__synaptic_pre.size();
	///// POINTERS ////////////
 ...
 int32_t* __restrict  _ptr_array_synapses_4_targets = _array_synapses_4_targets;
 int32_t* __restrict  _ptr_array_synapses_4__synaptic_post = _array_synapses_4__synaptic_post;
 int32_t* __restrict  _ptr_array_synapses_4_sources = _array_synapses_4_sources;
 int32_t*   _ptr_array_synapses_4_N = _array_synapses_4_N;



const int _old_num_synapses = _ptr_array_synapses_4_N[0];
const int _new_num_synapses = _old_num_synapses + _numsources;

const int _N_pre = 800;
const int _N_post = 500;
...
for (int _idx=0; _idx<_numsources; _idx++) {
    ...
    const int32_t sources = _ptr_array_synapses_4_sources[_idx];
    const int32_t targets = _ptr_array_synapses_4_targets[_idx];
...
const int newsize = _dynamic_array_synapses_4__synaptic_pre.size();
...
_dynamic_array_synapses_4_lastupdate.resize(newsize);
_dynamic_array_synapses_4_w.resize(newsize);
// Also update the total number of synapses
_ptr_array_synapses_4_N[0] = newsize;


    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    synapses_4_synapses_create_array_codeobject_profiling_info += _run_time;
}
