...
void _run_neurongroup_2_thresholder_1_codeobject()
{	
	...
	///// CONSTANTS ///////////
	const int _numv = 3200;
const int _num_underspace = 3201;
	///// POINTERS ////////////
 	
 double* __restrict  _ptr_array_neurongroup_2_v = _array_neurongroup_2_v;
 int32_t* __restrict  _ptr_array_neurongroup_2__underspace = _array_neurongroup_2__underspace;
    ...
    for(int _idx=0; _idx<3200; _idx++)
    {
        ...
        if(_cond) {
            _ptr_array_neurongroup_2__underspace[_count++] = _idx;
        }
    }
    _ptr_array_neurongroup_2__underspace[3200] = _count;

    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    neurongroup_2_thresholder_1_codeobject_profiling_info += _run_time;
}
