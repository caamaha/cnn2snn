...
void _run_neurongroup_2_thresholder_codeobject()
{	
...
const int _num_spikespace = 3201;
	///// POINTERS ////////////
 ...
 int32_t* __restrict  _ptr_array_neurongroup_2__spikespace = _array_neurongroup_2__spikespace;
    ...
    _ptr_array_neurongroup_2__spikespace[3200] = _count;

    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    neurongroup_2_thresholder_codeobject_profiling_info += _run_time;
}
