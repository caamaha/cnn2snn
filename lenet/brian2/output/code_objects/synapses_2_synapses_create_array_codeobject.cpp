...
const int _num_presynaptic_idx = _dynamic_array_synapses_2__synaptic_pre.size();
...
const int _old_num_synapses = _ptr_array_synapses_2_N[0];
const int _new_num_synapses = _old_num_synapses + _numsources;

const int _N_pre = 2880;
...
const int newsize = _dynamic_array_synapses_2__synaptic_pre.size();
...
_ptr_array_synapses_2_N[0] = newsize;
    ...
    synapses_2_synapses_create_array_codeobject_profiling_info += _run_time;
}
