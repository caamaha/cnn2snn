...
const int _num_spikespace = 11;
 ...
 int32_t* __restrict  _ptr_array_neurongroup_6__spikespace = _array_neurongroup_6__spikespace;
	...
	const int32_t *_events = _ptr_array_neurongroup_6__spikespace;
	const int32_t _num_events = _ptr_array_neurongroup_6__spikespace[10];
	...
	for(int _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        double v;
        v = 0;
        _ptr_array_neurongroup_6_v[_idx] = v;

	}

    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    neurongroup_6_resetter_codeobject_profiling_info += _run_time;
}
