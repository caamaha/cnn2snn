...
void _run_neurongroup_thresholder_1_codeobject()
{	
	...
	///// CONSTANTS ///////////
	const int _numv = 11520;
const int _num_underspace = 11521;
	///// POINTERS ////////////
 	
 double* __restrict  _ptr_array_neurongroup_v = _array_neurongroup_v;
 int32_t* __restrict  _ptr_array_neurongroup__underspace = _array_neurongroup__underspace;
    ...
    long _count = 0;
    for(int _idx=0; _idx<11520; _idx++)
    {
        ...
        if(_cond) {
            _ptr_array_neurongroup__underspace[_count++] = _idx;
        }
    }
    _ptr_array_neurongroup__underspace[11520] = _count;

    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    neurongroup_thresholder_1_codeobject_profiling_info += _run_time;
}
