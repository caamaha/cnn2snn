...
void _run_synapses_6_pre_push_spikes()
{
    ...
    
    {
        ...
        synapses_6_pre.push(_ptr_array_neurongroup_5__spikespace, _ptr_array_neurongroup_5__spikespace[_num_spikespace-1]);
    }

    // Profiling
    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    synapses_6_pre_push_spikes_profiling_info += _run_time;
}
