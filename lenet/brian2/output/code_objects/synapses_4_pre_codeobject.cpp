...
{	
	...
	///// CONSTANTS ///////////
	double* const _array_synapses_4_lastupdate = _dynamic_array_synapses_4_lastupdate.empty()? 0 : &_dynamic_array_synapses_4_lastupdate[0];
const int _numlastupdate = _dynamic_array_synapses_4_lastupdate.size();
const int _numv_post = 500;
...
const int _numt = 1;
double* const _array_synapses_4_w = _dynamic_array_synapses_4_w.empty()? 0 : &_dynamic_array_synapses_4_w[0];
const int _numw = _dynamic_array_synapses_4_w.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_4__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_4_lastupdate = _array_synapses_4_lastupdate;
 ...
 double* __restrict  _ptr_array_synapses_4_w = _array_synapses_4_w;
 int32_t* __restrict  _ptr_array_synapses_4__synaptic_post = _array_synapses_4__synaptic_post;
   ...
   double v_post = _ptr_array_neurongroup_4_v[_postsynaptic_idx];
   const double w = _ptr_array_synapses_4_w[_idx];
   const double t = _ptr_array_defaultclock_t[0];
   double lastupdate;
   v_post += w;
   lastupdate = t;
   _ptr_array_synapses_4_lastupdate[_idx] = lastupdate;
   _ptr_array_neurongroup_4_v[_postsynaptic_idx] = v_post;
    ...
    synapses_4_pre_codeobject_profiling_info += _run_time;
}
