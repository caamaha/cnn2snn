...
{	
	...
	///// CONSTANTS ///////////
	double* const _array_synapses_5_lastupdate = _dynamic_array_synapses_5_lastupdate.empty()? 0 : &_dynamic_array_synapses_5_lastupdate[0];
const int _numlastupdate = _dynamic_array_synapses_5_lastupdate.size();
...
const int _numw = _dynamic_array_synapses_5_w.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_5__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_5_lastupdate = _array_synapses_5_lastupdate;
 ...
 int32_t* __restrict  _ptr_array_synapses_5__synaptic_post = _array_synapses_5__synaptic_post;
   ...
   double v_post = _ptr_array_neurongroup_5_v[_postsynaptic_idx];
   const double w = _ptr_array_synapses_5_w[_idx];
   const double t = _ptr_array_defaultclock_t[0];
   double lastupdate;
   v_post += w;
   lastupdate = t;
   _ptr_array_synapses_5_lastupdate[_idx] = lastupdate;
   _ptr_array_neurongroup_5_v[_postsynaptic_idx] = v_post;
    ...
    synapses_5_pre_codeobject_profiling_info += _run_time;
}
