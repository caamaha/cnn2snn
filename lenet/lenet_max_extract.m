...
model = './caffe/lenet_max_pooling_deploy.prototxt';
weights = './caffe/lenet_max_pooling_iter_10000.caffemodel';
...
save('brian2/weights/lenet_max_pooling.mat', 'conv1_weights', 'conv2_weights', 'ip1_weights', 'ip2_weights', 'softmax_weights');
