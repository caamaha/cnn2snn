...
#             batch_xs = test_images[0:FLAGS.batch_size]
#             resized_batch_xs = np.zeros((FLAGS.batch_size, 24, 24, 3))
#             batch_ys = test_labels[0:FLAGS.batch_size]
#
#             for i in range(FLAGS.batch_size):
#                 resized_batch_xs[i, :, :, :] = scipy.misc.imresize(
#                     batch_xs[i], [24, 24], 'bilinear')
#
#             predictions = sess.run(
#                 accuracy, feed_dict={images: resized_batch_xs, labels: batch_ys})
#
#             print(predictions)
