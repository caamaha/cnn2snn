...
const int _numN_outgoing = _dynamic_array_synapses_6_N_outgoing.size();
...
const int _num_presynaptic_idx = _dynamic_array_synapses_6__synaptic_pre.size();
...
const int _numN_incoming = _dynamic_array_synapses_6_N_incoming.size();
...
const int _num_synaptic_post = _dynamic_array_synapses_6__synaptic_post.size();
const int _numsources = 100;
const int _num_postsynaptic_idx = _dynamic_array_synapses_6__synaptic_post.size();
const int _numN = 1;
const int _num_synaptic_pre = _dynamic_array_synapses_6__synaptic_pre.size();
	///// POINTERS ////////////
 ...
 int32_t* __restrict  _ptr_array_synapses_6_targets = _array_synapses_6_targets;
 int32_t* __restrict  _ptr_array_synapses_6__synaptic_post = _array_synapses_6__synaptic_post;
 int32_t* __restrict  _ptr_array_synapses_6_sources = _array_synapses_6_sources;
 int32_t*   _ptr_array_synapses_6_N = _array_synapses_6_N;



const int _old_num_synapses = _ptr_array_synapses_6_N[0];
const int _new_num_synapses = _old_num_synapses + _numsources;

const int _N_pre = 10;
const int _N_post = 10;
_dynamic_array_synapses_6_N_incoming.resize(_N_post + 0);
_dynamic_array_synapses_6_N_outgoing.resize(_N_pre + 0);

for (int _idx=0; _idx<_numsources; _idx++) {
        
    const int32_t sources = _ptr_array_synapses_6_sources[_idx];
    const int32_t targets = _ptr_array_synapses_6_targets[_idx];
    const int32_t _real_sources = sources;
    const int32_t _real_targets = targets;


    _dynamic_array_synapses_6__synaptic_pre.push_back(_real_sources);
    _dynamic_array_synapses_6__synaptic_post.push_back(_real_targets);
    // Update the number of total outgoing/incoming synapses per source/target neuron
    _dynamic_array_synapses_6_N_outgoing[_real_sources]++;
    _dynamic_array_synapses_6_N_incoming[_real_targets]++;
}

// now we need to resize all registered variables
const int newsize = _dynamic_array_synapses_6__synaptic_pre.size();
_dynamic_array_synapses_6__synaptic_post.resize(newsize);
_dynamic_array_synapses_6__synaptic_pre.resize(newsize);
_dynamic_array_synapses_6_delay.resize(newsize);
_dynamic_array_synapses_6_lastupdate.resize(newsize);
_dynamic_array_synapses_6_w.resize(newsize);
// Also update the total number of synapses
_ptr_array_synapses_6_N[0] = newsize;


    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    synapses_6_synapses_create_array_codeobject_profiling_info += _run_time;
}
