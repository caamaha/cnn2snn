...
const int _numlastupdate = _dynamic_array_synapses_2_lastupdate.size();
const int _numv_post = 4;
...
const int _numt = 1;
double* const _array_synapses_2_w = _dynamic_array_synapses_2_w.empty()? 0 : &_dynamic_array_synapses_2_w[0];
const int _numw = _dynamic_array_synapses_2_w.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_2__synaptic_post.size();
	///// POINTERS ////////////
 ...
 double* __restrict  _ptr_array_synapses_2_w = _array_synapses_2_w;
 int32_t* __restrict  _ptr_array_synapses_2__synaptic_post = _array_synapses_2__synaptic_post;
   ...
   const double w = _ptr_array_synapses_2_w[_idx];
   const double t = _ptr_array_defaultclock_t[0];
   double lastupdate;
   v_post = _clip(v_post + w, 0, 1);
   lastupdate = t;
   ...
   _ptr_array_neurongroup_1_v[_postsynaptic_idx] = v_post;
    ...
    synapses_2_pre_codeobject_profiling_info += _run_time;
}
