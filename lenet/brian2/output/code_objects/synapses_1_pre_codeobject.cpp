...
const int _numlastupdate = _dynamic_array_synapses_1_lastupdate.size();
const int _numv_post = 2880;
...
const int _numt = 1;
double* const _array_synapses_1_w = _dynamic_array_synapses_1_w.empty()? 0 : &_dynamic_array_synapses_1_w[0];
const int _numw = _dynamic_array_synapses_1_w.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_1__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_1_w = _array_synapses_1_w;
 int32_t* __restrict  _ptr_array_synapses_1__synaptic_post = _array_synapses_1__synaptic_post;
   ...
   _ptr_array_neurongroup_1_v[_postsynaptic_idx] = v_post;
    ...
    synapses_1_pre_codeobject_profiling_info += _run_time;
}
