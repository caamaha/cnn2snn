...
const int _numN_outgoing = _dynamic_array_synapses_1_N_outgoing.size();
...
const int _num_presynaptic_idx = _dynamic_array_synapses_1__synaptic_pre.size();
...
const int _numN_incoming = _dynamic_array_synapses_1_N_incoming.size();
const int _numtargets = 11520;
...
const int _num_synaptic_post = _dynamic_array_synapses_1__synaptic_post.size();
const int _numsources = 11520;
const int _num_postsynaptic_idx = _dynamic_array_synapses_1__synaptic_post.size();
const int _numN = 1;
const int _num_synaptic_pre = _dynamic_array_synapses_1__synaptic_pre.size();
	///// POINTERS ////////////
...
const int _old_num_synapses = _ptr_array_synapses_1_N[0];
const int _new_num_synapses = _old_num_synapses + _numsources;

const int _N_pre = 11520;
const int _N_post = 2880;
_dynamic_array_synapses_1_N_incoming.resize(_N_post + 0);
_dynamic_array_synapses_1_N_outgoing.resize(_N_pre + 0);
...
const int newsize = _dynamic_array_synapses_1__synaptic_pre.size();
...
_ptr_array_synapses_1_N[0] = newsize;
    ...
    synapses_1_synapses_create_array_codeobject_profiling_info += _run_time;
}
