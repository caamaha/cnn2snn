...
const int _num_synaptic_pre = _dynamic_array_synapses_1__synaptic_pre.size();
 ...
 int32_t* __restrict  _ptr_array_synapses_1__synaptic_pre = _array_synapses_1__synaptic_pre;
    ...
    for(int _i=0; _i<_N_pre; _i++)
	{
        ...
        for(int _k=_uiter_low; _k<_uiter_high; _k+=_uiter_step)
        {
            ...
            for (int _repetition=0; _repetition<_n; _repetition++) {
                _dynamic_array_synapses_1_N_outgoing[_pre_idx] += 1;
                _dynamic_array_synapses_1_N_incoming[_post_idx] += 1;
                _dynamic_array_synapses_1__synaptic_pre.push_back(_pre_idx);
                _dynamic_array_synapses_1__synaptic_post.push_back(_post_idx);
			}
		}
	}

	// now we need to resize all registered variables
	const int32_t newsize = _dynamic_array_synapses_1__synaptic_pre.size();
    ...
    synapses_1_synapses_create_generator_codeobject_profiling_info += _run_time;
}
