...
const int _numlastupdate = _dynamic_array_synapses_3_lastupdate.size();
const int _numv_post = 800;
...
const int _numt = 1;
double* const _array_synapses_3_w = _dynamic_array_synapses_3_w.empty()? 0 : &_dynamic_array_synapses_3_w[0];
const int _numw = _dynamic_array_synapses_3_w.size();
...
const int _num_postsynaptic_idx = _dynamic_array_synapses_3__synaptic_post.size();
 ...
 double* __restrict  _ptr_array_synapses_3_w = _array_synapses_3_w;
 int32_t* __restrict  _ptr_array_synapses_3__synaptic_post = _array_synapses_3__synaptic_post;
   ...
   const double w = _ptr_array_synapses_3_w[_idx];
   ...
   _ptr_array_neurongroup_3_v[_postsynaptic_idx] = v_post;
    ...
    synapses_3_pre_codeobject_profiling_info += _run_time;
}
