...
void _run_neurongroup_3_thresholder_1_codeobject()
{	
	...
	///// CONSTANTS ///////////
	const int _numv = 800;
const int _num_underspace = 801;
	///// POINTERS ////////////
 	
 double* __restrict  _ptr_array_neurongroup_3_v = _array_neurongroup_3_v;
 int32_t* __restrict  _ptr_array_neurongroup_3__underspace = _array_neurongroup_3__underspace;
    ...
    for(int _idx=0; _idx<800; _idx++)
    {
        ...
        if(_cond) {
            _ptr_array_neurongroup_3__underspace[_count++] = _idx;
        }
    }
    _ptr_array_neurongroup_3__underspace[800] = _count;

    const double _run_time = (double)(std::clock() -_start_time)/CLOCKS_PER_SEC;
    neurongroup_3_thresholder_1_codeobject_profiling_info += _run_time;
}
