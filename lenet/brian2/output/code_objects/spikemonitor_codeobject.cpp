...
const int _num_source_i = 10;
 ...
 int32_t* __restrict  _ptr_array_neurongroup_6__spikespace = _array_neurongroup_6__spikespace;
 ...
 int32_t* __restrict  _ptr_array_neurongroup_6_i = _array_neurongroup_6_i;


	//// MAIN CODE ////////////

	int32_t _num_events = _ptr_array_neurongroup_6__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_neurongroup_6__spikespace[_j];
            if (_idx >= 0) {
                _start_idx = _j;
                break;
            }
        ...
        if (_num_events > 0) {
            ...
            for(int _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t _source_i = _ptr_array_neurongroup_6_i[_idx];
